...
import { LayoutDashboard, User, Package, ListPlus, MessageSquare, LogOut, Settings } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/pharmacy/settings', icon: Settings, label: 'Settings' },
];
...
export default function PharmacySidebar({ isMobile = false }) {
  if(isMobile) {
      return <NavContent />
  }
