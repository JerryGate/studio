...
const faqItems = [
  {
    question: "What is Medfast.ng?",
    answer: "Medfast.ng is an online platform that connects you to verified pharmacies in Nigeria, allowing you to order authentic medications and healthcare products for fast delivery to your doorstep."
  },
  {
    question: "Are the medications on Medfast.ng genuine?",
