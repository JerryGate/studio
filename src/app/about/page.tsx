    ...
    <div className="bg-background text-foreground">
      <header className="py-16 md:py-24 bg-primary/5 text-center">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-extrabold text-primary">About Medfast.ng</h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-24">
            <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-muted-foreground text-lg">
                    Founded by a team of passionate healthcare professionals and tech innovators, Medfast.ng was born out of a desire to solve a critical problem: the difficulty in accessing genuine medications quickly and safely in Nigeria. We saw the challenges - from counterfeit drugs to the logistical hurdles of reaching a pharmacy - and we knew there had to be a better way. Thus, Medfast.ng was created as a beacon of hope and a symbol of quality healthcare for all.
                </p>
            </div>
          </section>
